    ...
    async canActivate(context) {
        ...
        try {
            ...
            if (!payload.sub || !payload.email || !payload.role) {
                throw new common_1.UnauthorizedException('Token payload is missing required user details.');
            }
            if (payload.tokenType !== 'access') {
                throw new common_1.UnauthorizedException('Invalid token type specified in JWT.');
            }
